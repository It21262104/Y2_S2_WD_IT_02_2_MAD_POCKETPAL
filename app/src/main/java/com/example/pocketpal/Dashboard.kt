    ...
    override fun onCreateView(
       ...
       // return inflater.inflate(R.layout.fragment_dashboard, container, false)
        ...
        btnCredit.setOnClickListener {
            // Define the action to be taken when the button is clicked
            // For example, navigate to another activity or fragment
            val intent = Intent(activity, credit_main::class.java)
            startActivity(intent)
        }
        btnBudget.setOnClickListener {
            // Define the action to be taken when the button is clicked
            // For example, navigate to another activity or fragment
            val intent = Intent(activity, BudgetMain::class.java)
            startActivity(intent)
        }
        ...
        btnGoals.setOnClickListener {
            // Define the action to be taken when the button is clicked
            // For example, navigate to another activity or fragment
            val intent = Intent(activity, MainActivityGoal::class.java)
            startActivity(intent)
        }
